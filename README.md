...
<template>
  <div class="home">
    ...
    <wangButton type="primary">成功按钮</wangButton>
    <wangButton type="danger">危险按钮</wangButton>
    <wangButton type="warning">警告按钮</wangButton>
  </div>
</template>
...
export default {
  name: 'Home',
  components: {
    wangButton: () => import('../components/button/index.vue')
  }
}
</script>
...
<template>
  <div class="home">
    <wangButton>默认按钮</wangButton>
    <wangButton type="primary" round disabled>成功按钮</wangButton>
    <wangButton type="danger" round border disabled>危险按钮</wangButton>
    <wangButton type="warning" border>警告按钮</wangButton>
  </div>
</template>
...
<template>
  <div class="home">
    <wangButton>默认按钮</wangButton>
    <wangButton size="medium" type="primary" round disabled>成功按钮</wangButton>
    <wangButton size="small" type="danger" round border disabled>危险按钮</wangButton>
    <wangButton size="mini" type="warning" border>警告按钮</wangButton>
  </div>
</template>
...
<template>
  <div class="home">
    <wangButton>默认按钮</wangButton>
    <wangButton size="medium" type="primary" round disabled >a</wangButton>
    <wangButton size="small" type="danger" round border disabled>危险按钮</wangButton>
    <wangButton size="mini" type="warning" border>警告按钮</wangButton>
  </div>
</template>
...
<template>
  <div class="home">
    <wangButton>默认按钮</wangButton>
    <wangButton size="medium" type="primary" >成功按钮</wangButton>
    <wangButton type="danger" >危险按钮</wangButton>
    <wangButton type="warning" border>警告按钮</wangButton>
  </div>
</template>
...
<template>
  <div class="home">
    <wangButton block>默认按钮</wangButton>
    <wangButton size="medium" type="primary" block >成功按钮</wangButton>
    <wangButton type="danger" block>危险按钮</wangButton>
    <wangButton type="warning" border block>警告按钮</wangButton>
  </div>
</template>
...
<template>
  <div class="home">
    <wangButton >默认按钮</wangButton>
    <wangButton disabled :loading="flag" @click="handleSubmit" size="medium" type="primary"  >成功按钮</wangButton>
    <wangButton type="danger" >危险按钮</wangButton>
    <wangButton type="warning" >警告按钮</wangButton>
  </div>
</template>
